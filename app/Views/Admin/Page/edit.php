...
<?= $this->section("admin_main") ?>
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('page-admin/edit') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: auto; text-align: right;">
                            <button type="button" href="<?= base_url('post?for_menu=1') ?>" class="btn btn btn-info btn-sm btn-warning mb-2 js_duplicate" data-menu="PAGE_ADMIN" data-id="<?=$post['post_id']?>">Nhân bản</button>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select required class="form-control" data-post-type="<?= @$post['post_type']?>" id="<?php if ($post['slug']== SLUG_HOME_EN || $post['slug']== SLUG_HOME_VN) { echo 'choose-lang-create-home';} else{ echo 'choose-lang-create-page';}?>" name="lang">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input data-lang="<?php echo @$post['lang']?>" autocomplete="off" data-id="<?= @$post['post_id'] ?>" required type="text" class="form-control post_title_page" name="post_title"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 position-relative">
                            ...
                            <input autocomplete="off" data-id="<?= @$post['post_id'] ?>" type="text" class="form-control og_url_page" name="og_url" id="og_url"
