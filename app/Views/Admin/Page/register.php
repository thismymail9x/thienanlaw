...
<?= $this->section("admin_main") ?>
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('page-admin/register') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select required class="form-control" data-post-type="<?= @$post['post_type']?>" id="choose-lang-create-page" name="lang">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input data-lang="<?php echo $_COOKIE['lang']?>" autocomplete="off" data-id="0" required type="text" class="form-control post_title_page" name="post_title" id="post_title_page"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 position-relative">
                            ...
                            <input autocomplete="off" type="text" class="form-control og_url_page" name="og_url" id="og_url"
