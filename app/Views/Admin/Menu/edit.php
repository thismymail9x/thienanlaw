                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: auto; text-align: right;">
                            <button type="button" href="<?= base_url('post?for_menu=1') ?>" class="btn btn btn-info btn-sm btn-warning mb-2 js_duplicate" data-menu="MENU" data-id="<?=$post['post_id']?>">Nhân bản</button>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group hide-if-edit-menu">
                        ...
                        <textarea class="form-control" name="post_content" id="post_content_menu"
                                  placeholder="" aria-label="Post content" aria-describedby="span-6"
