...
<?= $this->section("admin_main") ?>
    <div class="card shadow mb-4">
        ...
        <form action="<?= base_url('dynamic-page/register') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input autocomplete="off" data-id="0" required type="text" class="form-control" name="canonical" id="seo_canonical"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 position-relative">
                            ...
                            <input required autocomplete="off" type="text" class="form-control" name="og_url" id="dynamic-page"
