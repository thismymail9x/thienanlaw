...
<?= $this->section("admin_main") ?>
    <div class="card shadow mb-4">
        <form action="<?= base_url('admins/edit') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input disabled autocomplete="off" value="<?= @$admin['admin_email']?>" type="email" class="form-control" id="inputEmail" placeholder="Email">

                    </div>
                    <div class="form-group col-md-4">
                        <label for="inputKey">Mật khẩu<span style="color: red;">(*)</span></label>
                        <input disabled autocomplete="off" value="<?= @$admin['admin_password']?>" type="password" class="form-control" id="inputPassword" placeholder="Tối thiểu 8 kí tự">
                    </div>
                    <div class="form-group col-md-4">
