...
<?= $this->section("admin_main") ?>
    <div class="card shadow mb-4">
        ...
        <form id="editPostForm" action="<?= base_url('post/edit/') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: auto; text-align: right;">
                            <button type="button" href="<?= base_url('post?for_menu=1') ?>" class="btn btn btn-info btn-sm btn-warning mb-2 js_duplicate" data-menu="POST" data-id="<?=$post['post_id']?>">Nhân bản</button>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputKey">Loại bài viết<span style="color: red;">(Chọn đầu tiên)</span></label>
                        <select required name="post_type" id="post_type_edit" class="form-control"
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select <?php if (!isset($post)) {echo 'disabled';}?> required class="form-control choose_lang_edit" data-post-type="<?= @$post['post_type']?>" data-category-slug="<?=@$category['slug']?>" id="choose-lang-create-edit" name="lang">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input data-lang="<?php echo @$post['lang']?>" autocomplete="off" data-slug="<?=@$category['slug']?>" data-id="<?=@$post['post_id']?>" required type="text" class="form-control post_title" name="post_title" id="post_title_edit"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 position-relative">
                            ...
                            <input autocomplete="off" type="text" data-id="<?php echo @$post['post_id']?>" class="form-control og_url_post" name="og_url" id="og_url"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 position-relative">
                            <label for="inputKey">Ảnh đại diện bài viết</label>
                            <input type="file" name="file" id="file" class="form-control">
                            <img style="width: 100px;height: 100px;margin-top: 10px;display: none" src="#" id="avatar" alt="avatar">
                            <?php
                            $attachments = explode(',',@$post['attachment']);
                            $width = ['700w','1024w','1w'];
                            if (count($attachments)>1) { ?>
                                <img class="js__image" id="js__image" style="width: 100px;height: 100px;margin-top: 10px;" src="<?php echo $attachments[2] ?>"
                                     srcset="
